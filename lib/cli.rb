  ...
  def play_game
    ...
    until win?
      ...
      when win?
        puts "\n\ You win!\n\ "
      when full_match?
        puts "\n\ You have #{number_of_full_matches} full match(es) and #{number_of_partial_matches} partial match(es).\n\ "
      when partial_match?
          puts "\n\ You have 0 full match(es) and #{number_of_partial_matches} partial match(es).\n\ "
      else
        puts "You have no total or partial matches."
      end
    end
  end
